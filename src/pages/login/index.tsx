...
export default function LoginPage() {
    ...
    return (
        <div className="h-full flex justify-center items-center  transition-colors duration-300">
            <div className="relative w-full max-w-sm lg:max-w-4xl  rounded-2xl shadow-2xl overflow-hidden" style={{ height: '700px' }}>
                ...
                {/* Overlay Panel */}
                <div className={`hidden lg:flex absolute top-0 left-0 w-1/2 h-full items-center justify-center bg-indigo-600 text-white transition-transform duration-700 ease-in-out ${isLogin ? 'translate-x-full' : 'translate-x-0'}`}>
