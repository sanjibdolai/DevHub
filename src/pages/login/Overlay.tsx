...
const Overlay: FC<OverlayProps> = ({ onSwitch, isLogin }) => (
    <div className="relative h-full w-full">
        ...
        <div className={`absolute inset-0 p-12 text-center flex flex-col justify-center items-center transition-opacity duration-500 ${isLogin ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <button onClick={onSwitch} className="self-center py-3 px-8 font-bold bg-white text-indigo-600 rounded-full shadow-md hover:bg-blue-50 transition-transform transform hover:scale-105 duration-300">
                Sign Up
            </button>
        </div>
